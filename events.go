...
// EventResponse the entire response
...
// EventResource the event resources
type EventResource struct {
	Meta   Meta        `json:"metadata"`
	Entity EventEntity `json:"entity"`
}

//EventQuery a struct for defining queries like 'q=filter>value' or 'q=filter IN a,b,c'
...
func (c *Client) ListEvents() ([]EventEntity, error) {
